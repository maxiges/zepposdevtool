...
func HandlerDisplayData(w http.ResponseWriter, r *http.Request) {
	...
	// Retrieve stored data for the specified application
	...
	// Generate x-axis labels and populate chart data from all recorded samples
	...
	for i, dataRecord := range data {
		...
		// Track system memory usage as a percentage of total
